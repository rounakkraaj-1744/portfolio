    ...
    items: [
      {
        tag: "TASK",
        type: "solution",
        text: "Built a real-time drone fleet monitoring platform using Next.js, Socket.IO, MQTT/EMQX, and AWS, enabling live telemetry, fleet tracking, and drone video streaming.",
      },
      {
        tag: "ACTIONS",
        type: "solution",
        text: "Designed the telemetry pipeline with EMQX MQTT pub/sub, persistent storage, and Socket.IO real-time updates, while deploying containerized services on AWS EC2 with Docker and Nginx.",
      },
      {
        tag: "RESULT",
        type: "result",
        text: "Optimized Docker builds and implemented blue-green deployments with GitHub Actions, reducing deployment time by 35% while minimizing service disruption.",
      },
    ],
  },
  {
